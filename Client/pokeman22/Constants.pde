...
void init_constants() {
  ...
  SLIDER = new Rect((width/7)*6-width/140, height/9 + SELECTSCREENSHIFT, width/140, height/45);
  sliderStartY = height/9 + SELECTSCREENSHIFT;
  ...
  SEARCH_BUTTON = new Rect(width/7 + 10, 10 + SELECTSCREENSHIFT, 200, 30);
